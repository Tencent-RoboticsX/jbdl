...
void osqp_set_default_settings(OSQPSettings *settings) {
  ...
  //printf("The first line in osqp_set_default_settings()!!!!!!\n");
...
c_int osqp_setup(OSQPSolver** solverp,
  ...
  //printf("The first line in osqp_setup()!!!!!!!!\n");
  // Validate data
