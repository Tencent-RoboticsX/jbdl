...
c_int validate_data(const csc* P,
  ...
  //printf("we are in the first line of validate_data().\n");
...
# endif /* ifdef PRINTING */
  ...
  //printf("No problem, we will return 0 to main function.\n");
  return 0;
}
