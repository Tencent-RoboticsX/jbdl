...
pure_env_params = (
    ...
    ic_params_torso, ic_params_thigh, ic_params_leg, ic_params_foot)
...
v_dynamics_step_with_params = jax.vmap(env.dynamics_step_with_params,
    (None, None, None, 0, 0, None, None, None, None, None, None, None, None), 0)
...
start = time.time()
dns_to_action = jax.jit(jax.jacfwd(env.dynamics_step_with_params, argnums=6), static_argnums=[0, 1, 2])
print(dns_to_action(
    env.dynamics_fun, env.events_fun, env.impulsive_dynamics_fun, state, action, *pure_env_params))
duration = time.time() - start
print("duration:", duration)
...
start = time.time()
v_dns_to_action = jax.vmap(dns_to_action,  (None, None, None, 0, 0, None, None, None, None, None, None, None, None), 0)
